...
$EndDescr
$Comp
L MCU_Intel:8080A U32
U 1 1 60D604B8
P 4850 3650
F 0 "U32" H 4550 5450 50  0000 C CNN
F 1 "8080A" H 5150 5450 50  0000 C CNN
F 2 "Package_DIP:DIP-40_W15.24mm" H 4850 4250 50  0001 C CNN
F 3 "http://datasheets.chipdb.org/Intel/MCS-80/intel-8080.pdf" H 4850 4250 50  0001 C CNN
	1    4850 3650
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	3500 5400 3350 5400
Text Notes 3400 5650 0    20   ~ 0
looks like /Q \nbut shows pin 5\n
$Comp
L 8228:8228 U33
U 1 1 60D8FCA2
P 6700 4800
F 0 "U33" H 6700 6137 60  0000 C CNN
F 1 "8228" H 6700 6031 60  0000 C CNN
F 2 "Package_DIP:DIP-28_W15.24mm" H 6700 4800 60  0001 C CNN
...
U 1 1 60DBDF68
P 1550 2350
F 0 "C3" V 1802 2350 50  0000 C CNN
F 1 "8p2" V 1711 2350 50  0000 C CNN
F 2 "Capacitor_THT:C_Disc_D3.4mm_W2.1mm_P2.50mm" H 1588 2200 50  0001 C CNN
...
U 1 1 60E113F5
P 9350 3200
F 0 "#PWR015" H 9350 2950 50  0001 C CNN
...
privD1
Text GLabel 5950 3650 1    50   Input ~ 0
privD1
Wire Wire Line
	5950 3650 5950 3850
...
U 1 1 60EFA17E
P 7300 5400
F 0 "R25" H 7370 5446 50  0000 L CNN
F 1 "1K" H 7370 5355 50  0000 L CNN
...
F 1 "+12V" H 7315 5823 50  0000 C CNN
...
F 1 "+5V" V 2215 3278 50  0000 L CNN
...
F 1 "+12V" V 2215 3378 50  0000 L CNN
...
U 1 1 610C4F56
P 8850 2750
F 0 "#PWR012" H 8850 2600 50  0001 C CNN
F 1 "+5V" V 8865 2878 50  0000 L CNN
...
U 1 1 610CFCFD
P 8850 5700
F 0 "#PWR013" H 8850 5550 50  0001 C CNN
F 1 "+5V" V 8865 5828 50  0000 L CNN
...
U 1 1 610DB8A2
P 9350 1000
F 0 "#PWR014" H 9350 850 50  0001 C CNN
...
Entry Wire Line
	8000 2600 8100 2500
$Comp
L Device:Jumper_NO_Small PR2
U 1 1 6113D588
P 8400 2500
F 0 "PR2" H 8400 2400 50  0000 C CNN
F 1 "Jumper_NO_Small" H 7950 2400 50  0001 C CNN
...
U 1 1 610DB144
P 9350 3950
F 0 "#PWR016" H 9350 3800 50  0001 C CNN
...
Wire Wire Line
	8950 5750 8850 5750
$Comp
L Memory_EPROM:27C128 U34
U 1 1 610F9331
P 9350 5050
F 0 "U34" H 9650 6250 50  0000 C CNN
F 1 "27C64/128" H 9650 6150 50  0000 C CNN
F 2 "Package_DIP:DIP-28_W15.24mm" H 9350 5050 50  0001 C CNN
F 3 "http://ww1.microchip.com/downloads/en/devicedoc/11003L.pdf" H 9350 5050 50  0001 C CNN
	1    9350 5050
	1    0    0    -1  
$EndComp
Wire Wire Line
...
¬MRD
Text Notes 8350 5950 0    20   ~ 0
UNCERTAIN
Text Label 8100 3000 0    50   ~ 0
¬MRD
Text Notes 8350 3000 0    20   ~ 0
UNCERTAIN
...
U 1 1 613854AF
P 4350 4950
F 0 "#PWR04" H 4350 4700 50  0001 C CNN
...
F 1 "7486" H 3050 4734 50  0000 C CNN
F 2 "Package_DIP:DIP-14_W7.62mm" H 3050 4500 50  0001 C CNN
F 3 "74xx/74ls86.pdf" H 3050 4500 50  0001 C CNN
	1    3050 4500
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 616FC889
P 3050 5500
F 0 "U4" H 3050 5981 50  0000 C CNN
F 1 "7474" H 3050 5890 50  0000 C CNN
F 2 "Package_DIP:DIP-14_W7.62mm" H 3050 5500 50  0001 C CNN
F 3 "74xx/74hc_hct74.pdf" H 3050 5500 50  0001 C CNN
	1    3050 5500
	1    0    0    -1  
$EndComp
NoConn ~ 3050 5800
...
A5
Text GLabel 6500 2200 2    50   Output ~ 0
A6
...
$EndSheet
$Comp
L Memory_EPROM:27C128 U35
U 1 1 610DC8CD
P 9350 2100
F 0 "U35" H 9650 3300 50  0000 C CNN
F 1 "27C64/128" H 9650 3200 50  0000 C CNN
F 2 "Package_DIP:DIP-28_W15.24mm" H 9350 2100 50  0001 C CNN
F 3 "http://ww1.microchip.com/downloads/en/devicedoc/11003L.pdf" H 9350 2100 50  0001 C CNN
	1    9350 2100
	1    0    0    -1  
$EndComp
Wire Wire Line
...
$Comp
L Connector_Generic:Conn_02x15_Odd_Even K?
U 1 1 611AA92B
P 1600 4650
AR Path="/612BDE16/611AA92B" Ref="K?"  Part="1" 
AR Path="/611AA92B" Ref="K2"  Part="1" 
F 0 "K2" H 1650 5475 50  0000 C CNN
F 1 "Conn_02x15_Odd_Even" H 1650 5476 50  0001 C CNN
F 2 "TESLA-FRB:TX5133011-mato" H 1600 4650 50  0001 C CNN
...
U 1 1 612434F5
P 1400 5250
F 0 "#PWR0189" H 1400 5100 50  0001 C CNN
F 1 "+5V" V 1400 5450 50  0000 C CNN
...
U 1 1 6124503B
P 1400 5350
F 0 "#PWR0190" H 1400 5100 50  0001 C CNN
F 1 "GND" V 1400 5150 50  0000 C CNN
...
U 1 1 612463C5
P 1900 5350
F 0 "#PWR0191" H 1900 5100 50  0001 C CNN
F 1 "GND" V 1900 5150 50  0000 C CNN
...
U 1 1 61246BF2
P 1900 5250
F 0 "#PWR0192" H 1900 5100 50  0001 C CNN
F 1 "+5V" V 1900 5450 50  0000 C CNN
...
U 1 1 61247417
P 1400 5150
F 0 "#PWR0193" H 1400 5250 50  0001 C CNN
F 1 "-5V" V 1400 5350 50  0000 C CNN
...
U 1 1 61247F12
P 1900 5150
F 0 "#PWR0194" H 1900 5250 50  0001 C CNN
F 1 "-5V" V 1900 5350 50  0000 C CNN
...
U 1 1 6124860E
P 1400 5050
F 0 "#PWR0195" H 1400 4900 50  0001 C CNN
F 1 "+12V" V 1400 5250 50  0000 C CNN
...
U 1 1 61249834
P 1900 5050
F 0 "#PWR0196" H 1900 4900 50  0001 C CNN
F 1 "+12V" V 1900 5250 50  0000 C CNN
...
U 1 1 6126A235
P 1050 4250
F 0 "R26" H 850 4300 50  0000 L CNN
F 1 "270R" H 800 4200 50  0000 L CNN
F 2 "mato-rescue:R_Axial_Bend" V 980 4250 50  0001 C CNN
...
U 1 1 6126AAFD
P 1050 4400
F 0 "#PWR0197" H 1050 4150 50  0001 C CNN
...
Wire Wire Line
	1050 4050 1400 4050
Text Notes 650  3750 0    39   ~ 0
In the origianl scheme, \nINT (3) and D6 (4) are swapped
$Comp
L Connector:Conn_01x01_Female K6
U 1 1 6102B506
P 2200 3950
F 0 "K6" H 2250 3950 50  0000 L CNN
F 1 "K6" H 2228 3885 50  0001 L CNN
F 2 "mato-rescue:mato-K6" H 2200 3950 50  0001 C CNN
...
U 1 1 610F9E45
P 2900 3150
F 0 "U27" H 2875 4137 60  0000 C CNN
F 1 "8224" H 2875 4031 60  0000 C CNN
F 2 "Package_DIP:DIP-16_W7.62mm" H 2875 4031 60  0001 C CNN
...
Wire Bus Line
	7700 4750 7700 6050
Wire Bus Line
	10150 3450 10150 4750
Wire Bus Line
	3950 2850 3950 6050
Wire Bus Line
	7700 3450 7700 4350
Wire Bus Line
	10150 1300 10150 3450
Wire Bus Line
	6850 1300 6850 2900
Wire Bus Line
	6200 1300 6200 3000
